...
Editor:  Maryam Babaie, Mahyar Samani, Victor Borup
...
**Due on April 25 11:59 pm (PST)**: See [Submission](#submission) for details

## Table of Contents

- [Introduction](#introduction)
- [The Iron Law for Performance](#The-Iron-Law-for-Performance)
- [Workload](#workload)
...
#### RISC-V vs MIPS
You should note that this assignment requires you to use CPUs that use the RISC-V ISA rather than MIPS. The reason for this is better support through the gem5 library for RISC-V. For the purposes of this and future assignments there is little difference between RISC-V and MIPS, as they are both RISC ISAs with similar assembly code. You will not be required to write any RISC-V assembly code in this or future assignments, but you may be required to read and understand some assembly code.

## The Iron Law For Performance
...
Another way to look at this formula is what changes can be made to improve (reduce) Time. To reduce Time, you have to reduce Instructions, clock cycles per instruction, or time per clock cycle. The number of Instructions is primarily based on the program itself, the compiler, and the ISA. Clock Cycles per Instruction and Time per Clock Cycle are based on the technology in the processor's microarchitecture. 
...
You are required to work on this assignment **In Groups of 2**. You may discuss high level concepts with others in the class but all the work must be completed by you and your partner.
